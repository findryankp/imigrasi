    ...
    <div class="now-showing-movies">
        ...
        <div class="col-md-4 movie-preview">
            <a href="select-show.html" class="mask">
                <img src="template/images/m1.jpg" class="img-responsive zoom-img" style="height: 25vh; width: 100%;" alt="" />
                <div class="m-movie-title">
                    <a class="m-movie-link" href="select-show.html">Orang Bali Mabuk</a>
                    <div class="clearfix"></div>
                    <div class="m-r-date">
                        <p><i class="fa fa-calendar-o"></i>03 Januari 2018</p>
